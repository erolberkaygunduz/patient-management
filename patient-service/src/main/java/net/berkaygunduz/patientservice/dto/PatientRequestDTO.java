package net.berkaygunduz.patientservice.dto;
...
public class PatientRequestDTO {
    ...
    public @NotBlank(message = "Adress is required.") String getAddress() {
        return address;
    }

    public void setAddress(@NotBlank(message = "Adress is required.") String address) {
